        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-300 text-sm focus:outline-none focus:border-gray-400 shadow-sm transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-300 text-sm focus:outline-none focus:border-gray-400 shadow-sm transition-colors resize-none"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-900 text-sm focus:outline-none focus:border-gray-400 shadow-sm transition-colors appearance-none cursor-pointer"
            >
          ...
          <div>
            ...
            <div className="mt-2 text-xs text-gray-400 min-h-[1.25rem]">
